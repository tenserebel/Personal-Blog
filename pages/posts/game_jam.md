---
title: My Game Jam Experience.
date: 2025/12/07
description: Building an elf-themed game in 48 hours during a Christmas game jam.
tag: Game Development
author: Prem Shrawan Jha
---

# My Game Jam Experience: Building an Elf-Themed Game in 48 Hours
...
- We could write gameplay logic in Rust.
- We could use Godot's editor to manage assets, positioning, collisions, and scene layout visually.
...
- [Play the game on itch.io](https://chalp.itch.io/elfall)
- [View the source code on GitHub](https://github.com/HALP-Cardiff/elf-on-the-shelf)
...
- **Working under constraints** forces you to make decisions quickly and stick to them.
- **Choosing the right tools matters** — sometimes practicality beats ambition.
- **Teamwork is everything** in a fast-paced environment. Having a supportive and skilled team made the experience far more enjoyable and productive.
